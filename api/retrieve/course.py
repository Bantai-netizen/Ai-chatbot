# Vercel Python Serverless Function for course transcript retrieval
import os
import json
import psycopg
...
def handler(request):
    # Vercel Python uses a WSGI-like interface; request is a dict
    ...
    try:
        ...
        where_clauses = []
        params: List[Any] = []
        # Example filters: module, lesson, speaker
        ...
        if "speaker" in filters:
            where_clauses.append("%s = ANY (SELECT jsonb_array_elements_text(metadata->'speakers'))")
